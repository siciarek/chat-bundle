 ...
 */
class ChatChannelAssignee extends \Siciarek\ChatBundle\Entity\ChatChannelAssignee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannelAssignee' . "\0" . 'id', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannelAssignee' . "\0" . 'channel', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannelAssignee' . "\0" . 'assigneeId', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannelAssignee' . "\0" . 'assigneeClass', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt', 'deletedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChatChannelAssignee $proxy) {
