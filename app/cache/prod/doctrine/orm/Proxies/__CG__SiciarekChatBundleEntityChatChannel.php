...
namespace Proxies\__CG__\Siciarek\ChatBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ChatChannel extends \Siciarek\ChatBundle\Entity\ChatChannel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannel' . "\0" . 'id', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannel' . "\0" . 'messages', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannel' . "\0" . 'assignees', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannel' . "\0" . 'type', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannel' . "\0" . 'name', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatChannel' . "\0" . 'closedAt', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt', 'deletedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChatChannel $proxy) {
