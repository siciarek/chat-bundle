 ...
 */
class ChatMessage extends \Siciarek\ChatBundle\Entity\ChatMessage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatMessage' . "\0" . 'id', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatMessage' . "\0" . 'channel', '' . "\0" . 'Siciarek\\ChatBundle\\Entity\\ChatMessage' . "\0" . 'content', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt', 'deletedAt'];
        }
