...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the 'chat.channel' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Siciarek\ChatBundle\Model\ChatChannel A Siciarek\ChatBundle\Model\ChatChannel instance.
     */
    ...
    /**
     * Gets the 'chat.message' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Siciarek\ChatBundle\Model\ChatMessage A Siciarek\ChatBundle\Model\ChatMessage instance.
     */
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Timestampable\TimestampableSubscriber($c, true, 'Knp\\DoctrineBehaviors\\Model\\Timestampable\\Timestampable', 'datetime'));
        $d->addEventSubscriber(new \Knp\DoctrineBehaviors\ORM\Blameable\BlameableSubscriber($c, true, 'Knp\\DoctrineBehaviors\\Model\\Blameable\\Blameable', new \Knp\DoctrineBehaviors\ORM\Blameable\UserCallable($this), NULL));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('path' => NULL, 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'siciarek_chat', 'user' => 'root', 'password' => 'pass', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_013b5a16c618fa4fe0b226d6d1f09565b1c36d4640b57b1b201ee7dfd4a31952');
    ...
    protected function getSecurity_FirewallService()
    {
        ...
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.main' => $a, 'security.firewall.map.context.simple' => $a)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('number_format' => array('decimals' => 2, 'decimal_point' => ',', 'thousands_separator' => ' '), 'date' => array('format' => 'Y-m-d H:i', 'timezone' => 'Europe/Warsaw', 'interval_format' => '%d days'), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
...
incididunt ut labore et dolore magna aliqua.');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[4].'/baseapp/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/views'), 'Debug');
        $instance->addPath(($this->targetDirs[4].'/baseapp/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views'), 'WebProfiler');
        $instance->addPath(($this->targetDirs[4].'/baseapp/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views'), 'SensioDistribution');
        $instance->addPath(($this->targetDirs[4].'/baseapp/vendor/raulfraile/ladybug-bundle/RaulFraile/Bundle/LadybugBundle/Resources/views'), 'RaulFraileLadybug');
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/private'), array(0 => 'ROLE_USER'), NULL);
    ...
    /**
     * Gets the 'security.user.provider.concrete.demo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
